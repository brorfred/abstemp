...
| `ecearth_maxmonsst_2095-2100.nc` | Per-pixel max/min monthly SST statistics for EC-Earth3-CC SSP5-8.5 2095–2100 (same variables as the OSTIA maxmonsst files). |
...
data.generate_maxmonsst_files()   # ostia_maxmonsst_1985-1990.nc, ostia_maxmonsst_2019-2023.nc
```
